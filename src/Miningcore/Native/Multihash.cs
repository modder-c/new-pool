...
public static unsafe class Multihash
{
    ...
    public static extern void scrypt(byte* input, void* output, uint n, uint r, uint inputLength);
      ...
      [DllImport("libmultihash", EntryPoint = "eaglesong_export", CallingConvention = CallingConvention.Cdecl)]
    public static extern void eaglesong(byte* input, void* output, uint n, uint r, uint inputLength);
